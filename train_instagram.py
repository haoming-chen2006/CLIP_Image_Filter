...
from dataset import CLIPDataset, get_transforms, load_instagram_data
from clip import CLIPModel
from utils import AvgMeter, get_lr


def save_checkpoint(model, optimizer, epoch, best_loss, folder="checkpoints_instagram"):
...
def load_latest_checkpoint(model, optimizer, folder="checkpoints_instagram"):
...
def main():
    print("CLIP Training - Instagram Dataset")
    print("=" * 50)

    CFG.image_path = "/pscratch/sd/h/haoming/Projects/clip/artworks/instagram_data"

    image_names, captions = load_instagram_data()
    ...
    for epoch in range(start_epoch, CFG.epochs):
        ...
        if valid_loss.avg < best_loss:
            ...
            torch.save(model.state_dict(), "best_instagram.pt")
